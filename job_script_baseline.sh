...
#SBATCH -J "go_flow_llm_baseline"   # job name
#SBATCH -o "out_gfllm_baseline"   # job output file
#SBATCH -e "err_gfllm_baseline"   # job error file
...
python src/mirna_curator/baseline/constrainedLLMApplication.py --config configs/curation_config_QwQ_baseline.json
